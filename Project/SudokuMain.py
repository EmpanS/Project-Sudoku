...
This script allows the user to solve a Sudoku board by specifying the image-path as an argument, the image needs to
contain a Sudoku board. This script works best on image taken on real paper where the Sudoku board takes up almost the
whole picture.

To use this script, run the following in the command line (but with your own path to your image of the Sudoku!)
python SudokuMain.py "C:\Users\Emil\Desktop\sudoku_image.jpg"
...
This script can also be run in an IDE, but then the user has to manipulate and manually set the image_path.
"""
